    ...
    <div class="page-tab">  
        <div class="wrapperNew">
            ...
            <el-table :data="tableData" border show-summary style="width: 100%">          
                <el-table-column prop="code" label="编码" width="155" align="center"></el-table-column>
                <el-table-column prop="balanceDirection" label="名称" width="205" align="center"></el-table-column>
                <el-table-column prop="auxiliaryAccounting" label="汇率" width="105" align="center"></el-table-column>
                <el-table-column prop="auxiliaryAccounting" label="是否本位币" width="155" align="center"></el-table-column>
