    ...
    <div class="page-tab">  
        <div class="wrapperNew">
            ...
            <el-table :data="tableData" border show-summary style="width: 100%">      
                <el-table-column prop="code" label="名称" width="355" align="center"></el-table-column>
                <el-table-column prop="balanceDirection" label="类别" width="155" align="center"></el-table-column>
                <el-table-column prop="auxiliaryAccounting" label="模板类型" width="155" align="center"></el-table-column>
                <el-table-column prop="auxiliaryAccounting" label="默认类型" width="105" align="center"></el-table-column>
